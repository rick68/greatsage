...
pub const KNOWN_COMMANDS: &[ReplCommand] = &[
    ...
    ReplCommand {
        ...
        detail: concat!(
            ...
            "\n",
            "While a command is running, Ctrl+C interrupts it (does not quit greatsage);\n",
            "Ctrl+D sends EOF to the command's stdin.\n",
            "\n",
            "Examples:\n",
            "  /run git status\n",
            "  !ls -la\n",
    ...
    ReplCommand {
        name: "/bg",
        summary: "Manage background shell processes (run/list/output/kill)",
        cli_summary: Some("Background shell jobs (run/list/output/kill)"),
        short_description: Some("Manage background shell processes"),
        category: ReplCommandCategory::Project,
        args: "<sub>",
        arg_hint: "run | list | output | kill",
        help_extra_lines: &[],
        usage: "/bg — Manage background shell processes",
        detail: concat!(
            "Subcommands:\n",
            "  /bg run <command>\tLaunch a command in the background\n",
            "  /bg list\t\tShow all background jobs (default)\n",
            "  /bg output <id>\tShow output of a job (last 50 lines)\n",
            "  /bg output <id> --all\tShow all output\n",
